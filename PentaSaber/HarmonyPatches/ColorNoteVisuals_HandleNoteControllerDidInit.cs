...
namespace PentaSaber.HarmonyPatches
{
    ...
    public class ColorNoteVisuals_HandleNoteControllerDidInit
    {
        /// <summary>
        /// This code is run before the original code in MethodToPatch is run.
        /// </summary>
        static void Postfix(ColorNoteVisuals __instance, ref NoteControllerBase noteController,
            MaterialPropertyBlockController[] ____materialPropertyBlockControllers, ref Color ____noteColor)
        {
